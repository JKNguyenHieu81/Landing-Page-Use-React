//img: describeFirst.jpg
import { Component } from "react";
import describeFirst from "./img/describeFirst.jpg";
class SectionStore extends Component {
  render() {
    return (
      <div className="content-section create-section">
        <div className="img-content">
          <img className="describe-first" alt="img" src={describeFirst} />
        </div>
        <SectionText
          subTitleText="Build your business"
          titleText="Create Your Store"
          descriptionText="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
